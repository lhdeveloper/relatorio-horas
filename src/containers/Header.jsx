        ...
        <header className="bg-secondary p-2 p-sm-4">
            <nav className="navbar navbar-expand-lg navbar-dark bg-transparent">
                <a className="navbar-brand border-right pr-4" href="/">
                    ...
                    </svg> <span className="d-none d-sm-block">Relatório de Horas</span>
                </a>
                ...
                <div className="dropdown bg-red justify-content-end mt-2 mt-sm-0 ml-sm-auto">
                    ...
                    </svg>  Olá{infosUser.name ? ',' : ''} {infosUser.name}!
                    </button>
