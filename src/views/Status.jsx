                        ...
                        <div className="media flex-grow-1">
                            ...
                            <div className="d-inline-block ml-3">
                                <div className="start text-center">
                                    <svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-list-check text-secondary" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="media flex-grow-1">
                            ...
                            <div className="d-inline-block ml-3">
                                <div className="start text-center">
                                    <svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-hourglass-split text-info" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="media flex-grow-1">
                            ...
                            <div className="d-inline-block ml-3">
                                <div className="start text-center">
                                    <svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-clock-fill text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
